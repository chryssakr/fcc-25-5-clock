function App() {
    ...
    const audioBeepRef = React.useRef(new Audio('https://raw.githubusercontent.com/freeCodeCamp/cdn/master/build/testable-projects-fcc/audio/BeepSound.wav'));
    ...
    return (
      <div className = "center-align">
        ...
        <button id = "start_stop" className = "btn deep-orange lighten-1" onClick = {controlTime}>
          {isTimerOn ? (
        ...
        <button id = "reset" className = "btn deep-orange lighten-1" onClick = {resetTime}>
